...
public class ListaHistoricoPedidoItemAdapter extends BaseAdapter {
	...
	public ListaHistoricoPedidoItemAdapter(Context context, List<HistoricoPedidoItens> lista) {
	...
	public View getView(int posicao, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.adapter_lista_historico_pedido_item, null);
			
			holder = new ViewHolder();
			holder.tvProduto = (TextView) convertView.findViewById(R.id.tvHistoricoItemNomeProduto);
			holder.tvQtd = (TextView) convertView.findViewById(R.id.tvHistoricoItemQtd);
